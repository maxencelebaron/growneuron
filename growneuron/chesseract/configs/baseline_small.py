"""Baseline config for Chesseract runs.

This mirrors the CIFAR setup but starts from P-DARTS/PC-DARTS-friendly
optimization defaults (SGD, 0.025 base LR, 600 epochs, wd 3e-4).
"""
